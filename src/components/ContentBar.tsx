    ...
    return (
      <div
        className={`
          ...
          ${isScrolling || isExpanded ? "backdrop-blur-[3px] bg-[radial-gradient(rgba(0,0,0,0)_0px,var(--color-light)_1px)] dark:bg-[radial-gradient(rgba(0,0,0,0)_0px,var(--color-dark-900)_2px)] bg-[size:5px_5px] side-shadow" : ""}
